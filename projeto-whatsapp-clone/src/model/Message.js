...
export class Message extends Model {
    ...
    // Método que verifica o tipo da mensagem
    // boolean me para verificar se a mensagem é minha ou do contato
    getViewElement(me = true) {

        // Cria a div e coloca a classe message
        let div = document.createElement('div');
        div.className = 'message';

        // Faz um switch no tipo de arquivo
        switch(this.type){
        ...
        // Verifica se a mensagem é minha ou do contato. Se for minha, className recebe a classe message-out, message-in se for do contato
        let className = (me) ? 'message-out' : 'message-in';

        // Adiciona a classe ao primeiro elemento filho da div
    ...
    static send(chatId, from, type, content) {
        ...
        // Pega a referência do chat e da mensagem e adiciona a mensagem, com seu conteudo, timestamp, status, tipo e quem enviou
    ...
    // Método que pega a referência das mensagens
